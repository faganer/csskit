...
//             cancel: arguments[2], // 取消按钮
//             okText: arguments[3], // 确定按钮文本
//             cancelText: arguments[4], // 取消按钮文本
//             dialogBg: arguments[5], // 弹窗背景
//             dialogClass: arguments[6], // 弹窗类名
//             okClass: arguments[7], // 确定按钮类名
//             cancelClass: arguments[8], // 取消按钮类名
//         }
//     }
...
//         cancelClass = options.okClass || 'btn btn-light'; // 取消按钮类名
...
//         if (cancel) {
//             html += '<button type="button" class="' + cancelClass + '">' + cancelText + '</button>';
//         }
//         html += '<button type="button" class="' + okClass + '">' + okText + '</button>';
//         html += '</div></div>';
//         // 页面追加html
//         $("body").append(html);
//     };
...
window.dialog = function(options) {
    ...
    if (typeof(arguments[0]) == 'string' && arguments.length > 1) {
        options = {
            ...
            okText: arguments[4], // 确定按钮文本
            cancelText: arguments[5], // 取消按钮文本
            dialogClass: arguments[6], // 弹窗类名
            okClass: arguments[7], // 确定按钮类名
            cancelClass: arguments[8], // 取消按钮类名
        }
    ...
    if (content) {
        ...
        // 底部按钮
        $(".dialog-footer .btn").click(function() {
